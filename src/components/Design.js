      ...
      <div>
       {props.email.length == 0?(
        ...
        <img src="background.png" className="ml-36 lg:ml-9 w-[592px] sm:hidden xl:ml-8 md:ml-0 fixed h-[753px]" />
          ...
          <div>
        <img src="unlocked.png" className="absolute z-10 h-60 flex mt-48  ml-[409px]"/>
        <h1 className="absolute z-10 flex mt-[452px] ml-96 text-3xl font-[Poppins] font-semibold text-white">Congrats you are In</h1>
        <img src="background.png" className="ml-52 w-[592px] fixed h-[753px]"/>
        </div>
        )}
      </div>
    </div>
